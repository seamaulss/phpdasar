...
<!-- File ini digunakan untuk mengembalikan hasil pencarian mahasiswa saat user mengetik (live search).

Keyword diambil dari AJAX GET request.

Query mencari mahasiswa berdasarkan nama, NRP, email, atau jurusan.

Hasil dikembalikan sebagai tabel HTML yang langsung menggantikan konten di halaman utama.

Ada delay 0,5 detik untuk efek loading. -->
